    ...
    render() {
        return (
            <div className="ayuda-Component">
                ...
                <p style={{ color: 'white', margin: 30 }}>Para añadir un nueva ruta el usuario deberá ir a la pestaña mapa, una vez ahi deberá pinchar en el mapa para indicar el primer punto de la ruta, para seguir marcandos puntos de la ruta el usuario deberá pinchar nuevamente en el mapa creando puntos intermedios. Una vez seleccionado el primer punto se le abrirá un menú con la posibilidad de asociar imagenes a la ruta. Asocie tantas imagenes como quiera para eso deberá pulsar el botón "Seleccionar archivo". Una vez elegida la la imagen deberá pulsar el boton "Enviar", y repetir esta acción tantas veces como imagenes quierá asociar a la ruta. Cuando haya finalizado de añadir imagenes y puntos a la ruta pulsé el botón "Marcar ruta" para guardarla. Si desease ver la imagen de la ruta solamente deberá pulsa sobre un marcador de la ruta.</p>

    ...
    render() {
        return (
            <div className="ayuda-Component">
                ...
                <p style={{ color: "white", margin: 30 }}>Aquí dejo un pequeño video que muestra como una ruta con varios puntos.</p>
                ...
                <p style={{ color: "white", margin: 30 }}>Para visualizar sus rutas o las de sus amigos deberá ir a la pestaña mapa. Donde le aparecerán el nombre y la descripción de sus rutas y las compartidas por sus amigos. Para visualizarla solamente tendrá que pinchar sobre el nombre de aquella ruta que quiera ver.</p>
